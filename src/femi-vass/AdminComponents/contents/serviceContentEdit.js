          ...
          <div className="max-width-1200">
            ...
            {(this.state.smsType || this.state.ussdType) && (
              <React.Fragment>
                ...
                <Card
                  className={
                    (this.state.smsType && this.state.smsType.toLowerCase() !== "default") &&
                    (this.state.ussdType && this.state.ussdType.toLowerCase() !== "default")
                      ? "hide"
                      : ""
                  }
                  heading={
                    <Fragment>
                      {this.state.smsType && this.state.smsType.toLowerCase() === "default" && "SMS"}
                      {(this.state.smsType && this.state.smsType.toLowerCase() === "default") &&
                      (this.state.ussdType && this.state.ussdType.toLowerCase() === "default") &&
                        " / "}
                      {(this.state.ussdType && this.state.ussdType.toLowerCase() === "default") &&
