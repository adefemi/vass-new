...
import {fetchFileUpload, fetchFileUploadStream, fileUpload, primaryColor, userUrl} from "../../../utils/data";
import { Notification } from "../../../../components/common/notification";
import { errorHandler } from "../../../../components/utils/helper";
import { Spinner } from "../../../../components/common/spinner";
import { Select } from "../../../../components/common/select";
import {Upload} from "../../../../components/common/fileUpload";
            ...
            <div className="">
              {
                activeTab === "ivr" ?
                    <div className="">
                      ...
                      {
                        notificationData.subscription && <a style={{color: primaryColor}} onClick={e => getFileUrl(e, notificationData.subscription)} target="_blank">{
                          loadingLink ? <Spinner color={primaryColor} /> : notificationData.subscription
                        }</a>
                      }
            ...
            <div className="">
              {
                activeTab === "ivr" ?
                    <div className="">
                      ...
                      {
                        notificationData.deactivation && <a style={{color: primaryColor}} onClick={e => getFileUrl(e, notificationData.deactivation)} target="_blank">{
                          loadingLink ? <Spinner color={primaryColor} /> : notificationData.deactivation
                        }</a>
                      }
                    </div>
                    :<TextAreaField
            ...
            <div className="">
              {
                activeTab === "ivr" ?
                    <div className="">
                      ...
                      {
                        notificationData.charge && <a style={{color: primaryColor}} onClick={e => getFileUrl(e, notificationData.charge)} target="_blank">{
                          loadingLink ? <Spinner color={primaryColor} /> : notificationData.charge
                        }</a>
                      }
                    </div>
                    :<TextAreaField
            ...
            <div className="">
              {
                activeTab === "ivr" ?
                    <div className="">
                      ...
                      {
                        notificationData.renewal && <a style={{color: primaryColor}} onClick={e => getFileUrl(e, notificationData.renewal)} target="_blank">{
                          loadingLink ? <Spinner color={primaryColor} /> : notificationData.renewal
                        }</a>
                      }
                    </div>
                    :<TextAreaField
